...
export default function CurrentPositions({ items }: Props) {
        ...
        <View style={[globalStyles.flexRow, globalStyles.aic, globalStyles.jcb, globalStyles.flex1]}>
          <View style={[globalStyles.flexRow, globalStyles.aic]}>
            <View style={styles.iconContainer}>
              <PositionIcon size={24} color={theme.colors.primary} />
            </View>
            <CustomText text='Current Positions' size={16} color={theme.colors.text} fontWeight='medium' style={globalStyles.ml10} />
          </View>
