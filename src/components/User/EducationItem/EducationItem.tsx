...
export default function EducationItem({ item }: Props) {
    ...
    return (
        <TouchableOpacity style={styles.container} onPress={navigate}>
            <CustomText text={item.institution_name} size={18} color={theme.colors.text} fontWeight='medium' />
            <CustomText text={item.degree.name} size={16} color={theme.colors.text} fontWeight='regular'  style={globalStyles.mt5}/>
