...
export default function UserEducation({ items }: Props) {
        ...
        <View style={[globalStyles.flexRow, globalStyles.aic, globalStyles.jcb, globalStyles.flex1]}>
          <View style={[globalStyles.flexRow, globalStyles.aic]}>
            <View style={styles.iconContainer}>
              <EducationIcon size={26} color={theme.colors.primary} />
            </View>
            <CustomText text='Education' size={16} color={theme.colors.text} fontWeight='medium' style={globalStyles.ml10} />
          </View>
